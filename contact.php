  ...
  <section class="ftco-section contact-section ftco-degree-bg">
    <div class="container">
      <div class="row d-flex mb-5 contact-info">
        ...
        <div class="w-100"></div>
        <div class="col-md-3">
          <p><span>Address:</span> 	CUTM, BBSR</p>
        </div>
        <div class="col-md-3">
          <p><span>Phone:</span> <a href="tel://9556328216">+91 9556328216</a></p>
        </div>
        <div class="col-md-3">
          <p><span>Email:</span> <a href="mailto:situ@chinmayakumarbiswal.in"><span>situ@chinmayakumarbiswal.in</span></a></p>
        </div>
        <div class="col-md-3">
          <p><span>Website</span> <a href="https://chinmayakumarbiswal.in/">chinmayakumarbiswal.in</a></p>
        </div>
      </div>
