...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 27, 2023 at 06:27 AM
...
(5, '15InohpF2023NZEWe9Lp', 'Chinmaya Kumar Biswal', '210720100009@cutm.ac.in', '25-02-2023-12-35Chinmaya kumar biswal CV AWS.pdf'),
(6, 'ikKZrazg2023vBiO3lSJ', 'Chinmaya Kumar Biswal', '210720100009@cutm.ac.in', '26-02-2023-15-47Chinmaya kumar biswal CV AWS.pdf');
...
(2, 'aws ', '2023NZEWe9Lp', 'situ@chinmayakumarbiswal.in', 'create ec2', '15InohpF2023NZEWe9Lp');
...
(2, '2023NZEWe9Lp', 'situ@chinmayakumarbiswal.in', 'aws note', '25-02-2023-12-36Solution Architect Associate.pdf'),
(3, '2023NZEWe9Lp', 'situ@chinmayakumarbiswal.in', 'demo', '26-02-2023-15-56chinmayakumarbiswalDevops.pdf');
...
(3, 'test 3', 'test 3 for aws', '2023-02-26', '23:50', '23:59', '6odkJjHK2023vBiO3lSJ', 'situ@chinmayakumarbiswal.in', '2023vBiO3lSJ'),
(4, 'test 4', ' ', '2023-02-26', '23:50', '23:59', 'aO3B9EuN2023vBiO3lSJ', 'situ@chinmayakumarbiswal.in', '2023vBiO3lSJ'),
(5, 'demo', ' demo', '2023-02-25', '14:00', '14:31', '9UFJqNdT2023NZEWe9Lp', 'situ@chinmayakumarbiswal.in', '2023NZEWe9Lp');

-- --------------------------------------------------------

--
-- Table structure for table `examproctorimg`
--

CREATE TABLE `examproctorimg` (
  `id` int(11) NOT NULL,
  `roomIdAuto` varchar(255) NOT NULL,
  `examUniqueId` varchar(255) NOT NULL,
  `studentEmail` varchar(255) NOT NULL,
...
(12, '2023vBiO3lSJ', 'aO3B9EuN2023vBiO3lSJ', '210720100009@cutm.ac.in', '3'),
(13, '2023vBiO3lSJ', '6odkJjHK2023vBiO3lSJ', '210720100009@cutm.ac.in', '0');
...
(10, 'demo', 'demo', 'situ@chinmayakumarbiswal.in', '2023NZEWe9Lp', '210720100009@cutm.ac.in');
...
(5, '2023NZEWe9Lp', '9UFJqNdT2023NZEWe9Lp', 'demo', 'demo', 'demo', 'demo', 'demo', 'b');
...
(8, '2023NZEWe9Lp', 'demo', 'demo', 'situ@chinmayakumarbiswal.in');
...
CREATE TABLE `student` (
  ...
  `verifyStatus` varchar(255) NOT NULL,
...
INSERT INTO `student` (`id`, `name`, `email`, `bio`, `password`, `profileimage`, `verifyStatus`, `verifyCode`) VALUES
...
(6, 'Chinmaya Kumar Biswal', '210720100009@cutm.ac.in', '', 'b0cdf1a710c2fbedb32adcc57aaf2b46', '27-02-2023-09-29chinmaya.jpg', '', '');
...
INSERT INTO `teacher` (`id`, `name`, `email`, `bio`, `public`, `password`, `profileimage`, `verifyStatus`, `verifyCode`) VALUES
...
(6, ' chinmaya', 'situ@chinmayakumarbiswal.in', '', 'public', 'b0cdf1a710c2fbedb32adcc57aaf2b46', '25-02-2023-12-25chinmaya_white.jpg', '', '');
...
--
-- Indexes for table `examproctorimg`
--
ALTER TABLE `examproctorimg`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `examproctorimg`
--
ALTER TABLE `examproctorimg`
