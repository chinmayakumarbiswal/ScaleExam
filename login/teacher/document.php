                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-lg" placeholder="Document Name"
                                        aria-label="documentName" name="documentName">
                                </div>
                                <div class="form-group">
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <?php
                        $rooms=getAllDocuments($db,$roomIdAuto);          
